...
public class EmpleadoPorComision extends empleado {
    ...
    public EmpleadoPorComision(double ventasBrutas, double tarifasComision, String cedula, String nombres, String apellidos) {
    ...
    public double ingresos() {
        return getVentasBrutas() * getTarifasComision();
    }
